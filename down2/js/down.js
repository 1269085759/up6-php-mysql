...
function DownloaderMgr()
{
	...
	this.Config = {
        ...
        //file
        , "UrlCreate"   : "http://localhost:811/up6/down2/db/f_create.php"
        , "UrlDel"      : "http://localhost:811/up6/down2/db/f_del.php"
        , "UrlList"     : "http://localhost:811/up6/down2/db/f_list.php"
        , "UrlListCmp"  : "http://localhost:811/up6/down2/db/f_list_cmp.php"
        , "UrlUpdate"   : "http://localhost:811/up6/down2/db/f_update.php"
        , "UrlDown"     : "http://localhost:811/up6/down2/db/f_down.php"
	    //folder
        , "UrlFdData"   : "http://localhost:811/up6/down2/db/fd_data.php"
        //x86
        , ie: {
